        ...
        if int(pessoa['codigo_cliente'])==codigo:
            if pessoa['sexo'] == 'f':
                if int(pessoa['idade']) <= 16: #
                    dados(pessoa)
                    print(f"Ola {pessoa['nome']}! Você quer aproveitar nosso Tikito? É uma delicia!")
                ...
                if int(pessoa['idade']) <= 16:
                    ...
                    dados(pessoa)
                    print(f"Olá {pessoa['nome']}! Quer experimentar nosso refigerante? A sua amada vai adorar!")
                    break
                else:
                    dados(pessoa)
                    print(f"Olá {pessoa['nome']}! Já experimentou nossa cerveja? alto teor alcoolico!!!")
                    break
    print('\n')
