...
from Aula27.exercicios.geradorlista import lista_simples_inpura_int_str
from Aula27.exercicios.geradorlista import lista_simples_int
from Aula27.exercicios.geradorlista import lista_simples_str
from Aula27.exercicios.geradorlista import lista_simples_impura
from Aula27.exercicios.geradorlista import embaralhar
from Aula27.exercicios.geradorlista import embaralhar_int_str_hard
from Aula27.exercicios.geradorlista import binario
...
string = ''
lista_listas = [lista_cadastro, lista_cadastrados, lista_cadastrados1]
...
def nomes():
    lista = []
    for i in range(0,5):
        lista.append(input(f'Digite o número {i+1}: '))
    return lista
# nomes = nomes()
...
lista0 = []
def add_lista(lista0):
    lista1.sort()
    lista2.sort()
    lista0.append(lista1)
    lista0.append(lista2)
    lista0 = lista0[0] + lista0[1]
    return lista0

lista0 = add_lista(lista0)
print(f'\n{lista0}')

# 11) Ordene a lista0 e diga qual é o maior valor, menor valor e em quais das listas (lista1 ou lista2)
# estes pertencem.
lista0.sort()
print(f"O maior valor é: {max(lista0)}")
print(f"O menor valor é: {min(lista0)}")
if max(lista0) in lista1:
    print('O maior valor está na Lista1.')
else:
    print('O maior valor está na Lista2.')
if min(lista0) in lista1:
    print('O menor valor está na Lista1.')
else:
    print('O menor valor está na Lista2.')
