...
class LivroDao:
    ...
    def buscar_por_id(self,id):
        ...
        l = LivroModel(l[1],l[2],l[3],l[0])
        return l.__dict__

    f""" INSERT INTO 01_MDG_PESSOA
            (
                NOME,
                SOBRENOME,
                IDADE,
    ...
    def adicionar(self,livro:LivroModel):
        ...
        VALUES ('{livro.nome}','{livro.autor}','{livro.ano_publi}')""")
    ...
    def remover(self,id):
        self.cursor.execute(f"DELETE topskills01.Nicole_Livros; WHERE ID = {id}")
        self.connection.commit()
